...
public class ItemHoe extends net.minecraft.item.ItemHoe {
	...
	private final String pathHead = Reference.TexturePath + "head/hoe/";
	private final String pathHandle = Reference.TexturePath + "handle/hoe/";
	...
	private final String head = LoreLoader.HeadHoe;
	private final String handle = LoreLoader.HandleHoe;

	public ItemHoe(ItemPartMaterial head, ItemPartMaterial handle)
	{
	...
	public ItemHoe(ItemPartMaterial head)
	{
		super(head.getToolMaterial());
