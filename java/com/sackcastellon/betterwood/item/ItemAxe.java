...
public class ItemAxe extends net.minecraft.item.ItemAxe {
	...
	private final String pathHead = Reference.TexturePath + "head/axe/";
	private final String pathHandle = Reference.TexturePath + "handle/axe/";
	...
	private final String head = LoreLoader.HeadAxe;
	private final String handle = LoreLoader.HandleAxe;

	public ItemAxe(ItemPartMaterial head, ItemPartMaterial handle)
	{
	...
	public ItemAxe(ItemPartMaterial head)
	{
		super(head.getToolMaterial());
