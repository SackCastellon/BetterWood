...
public class ItemShovel extends net.minecraft.item.ItemSpade {
	...
	private final String pathHead = Reference.TexturePath + "head/shovel/";
	private final String pathHandle = Reference.TexturePath + "handle/shovel/";
	...
	private final String head = LoreLoader.HeadShovel;
	private final String handle = LoreLoader.HandleShovel;

	public ItemShovel(ItemPartMaterial head, ItemPartMaterial handle)
	{
	...
	public ItemShovel(ItemPartMaterial head)
	{
		super(head.getToolMaterial());
