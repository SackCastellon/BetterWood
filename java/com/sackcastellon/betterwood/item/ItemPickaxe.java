...
public class ItemPickaxe extends net.minecraft.item.ItemPickaxe {
	...
	private final String pathHead = Reference.TexturePath + "head/pickaxe/";
	private final String pathHandle = Reference.TexturePath + "handle/pickaxe/";
	...
	private final String head = LoreLoader.HeadPickaxe;
	private final String handle = LoreLoader.HandlePickaxe;

	public ItemPickaxe(ItemPartMaterial head, ItemPartMaterial handle)
	{
	...
	public ItemPickaxe(ItemPartMaterial head)
	{
		super(head.getToolMaterial());
